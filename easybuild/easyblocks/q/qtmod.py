...
class EB_Qtmod(ConfigureMake):
    ...
    def configure_step(self):
        ...
        if LooseVersion(self.version) < LooseVersion('5.9'):
            qa = {
    ...
    def build_step(self):
        ...
        super(EB_Qtmod, self).build_step()
    ...
    def sanity_check_step(self):
        ...
        super(EB_Qtmod, self).sanity_check_step(custom_paths=custom_paths)
