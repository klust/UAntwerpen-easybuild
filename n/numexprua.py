...
class EB_numexprUA(PythonPackage):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(EB_numexprUA, self).__init__(*args, **kwargs)

        self.imkl_root = None

    def configure_step(self):
        """Custom configuration procedure for numexpr."""
        super(EB_numexprUA, self).configure_step()
...
#
#        return super(EB_numexprUA, self).sanity_check_step(custom_commands=custom_commands)
