...
class EB_METISMOD(ConfigureMake):
    ...
    def build_step(self):
        ...
        super(EB_METISMOD, self).build_step()
    ...
    def sanity_check_step(self):
        ...
        super(EB_METISMOD, self).sanity_check_step(custom_paths=custom_paths)
